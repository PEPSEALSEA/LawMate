...
const templates: CaseTemplate[] = [
  {
    ...
    steps: [
      {
        title: 'Step 1: รวบรวมหลักฐาน',
        subtitle: 'Collect Evidence',
        detail: 'รวบรวมบันทึกเวลาเข้า-ออกงาน (Timesheets) และสลิปเงินเดือนย้อนหลัง',
      },
      {
        title: 'Step 2: ร่างคำร้องเรียน',
        subtitle: 'Draft Complaint',
        detail: 'ตรวจสอบแอกสารที่ AI ร่างให้ให้แน่ใจว่าข้อมูลถูกต้องและครบถ้วนก่อนดำเนินการต่อ',
        urgent: true,
      },
      {
        title: 'Step 3: ยื่นเรื่องต่อเจ้าหน้าที่',
        subtitle: 'Submit to Official',
        detail: 'ยื่นคำร้องต่อพนักงานตรวจแรงงาน หากไม่ได้รับการตอบสนอง',
      },
    ],
    insights: [
  ...
  },
  {
    ...
    steps: [
      {
        title: 'Step 1: ตรวจสอบสัญญาเช่า',
        subtitle: 'Review Contract',
        detail: 'อ่านเงื่อนไขการคืนเงินมัดจำ และรวบรวมภาพถ่ายสภาพห้องก่อน-หลังเช่า',
      },
      {
        title: 'Step 2: ส่งหนังสือทวงถาม',
        subtitle: 'Send Demand Letter',
        detail: 'ตรวจสอบหนังสือทวงถามที่ AI ร่างให้ก่อนส่งไปยังผู้ให้เช่าทางไปรษณีย์ตอบรับ',
        urgent: true,
      },
      {
        title: 'Step 3: ยื่นเรื่องต่อ สคบ.',
        subtitle: 'File to Consumer Protection',
        detail: 'หากผู้ให้เช่าไม่ตอบสนองภายในกำหนด ยื่นเรื่องร้องเรียนต่อสำนักงานคณะกรรมการคุ้มครองผู้บริโภค',
      },
    ],
    insights: [
  ...
  },
  {
    ...
    steps: [
      {
        title: 'Step 1: รวบรวมหลักฐานที่เกิดเหตุ',
        subtitle: 'Collect Accident Evidence',
        detail: 'ถ่ายภาพความเสียหาย บันทึกประจำวันจากตำรวจ และข้อมูลคู่กรณี',
      },
      {
        title: 'Step 2: แจ้งเคลมประกันภัย',
        subtitle: 'File Insurance Claim',
        detail: 'ตรวจสอบแบบฟอร์มเรียกร้องค่าสินไหมที่ AI ร่างให้ก่อนยื่นต่อบริษัทประกัน',
        urgent: true,
      },
      {
        title: 'Step 3: เจรจาค่าสินไหมทดแทน',
        subtitle: 'Negotiate Settlement',
        detail: 'หากเจรจาไม่สำเร็จ ยื่นเรื่องต่อ คปภ. เพื่อขอให้ไกล่เกลี่ย',
      },
    ],
    insights: [
  ...
  },
  {
    ...
    steps: [
      {
        title: 'Step 1: ตรวจสอบสัญญาและความเสียหาย',
        subtitle: 'Review Contract & Damages',
        detail: 'รวบรวมสัญญาฉบับจริง หลักฐานการสื่อสาร และประเมินมูลค่าความเสียหาย',
      },
      {
        title: 'Step 2: ส่งหนังสือแจ้งเตือน',
        subtitle: 'Send Notice of Breach',
        detail: 'ตรวจสอบหนังสือแจ้งเตือนผิดสัญญาที่ AI ร่างให้ก่อนส่งถึงคู่สัญญา',
        urgent: true,
      },
      {
        title: 'Step 3: เจรจาไกล่เกลี่ยหรือฟ้องร้อง',
        subtitle: 'Mediate or File Lawsuit',
        detail: 'หากไม่มีการแก้ไข พิจารณายื่นฟ้องต่อศาลหรือขอไกล่เกลี่ยข้อพิพาททางธุรกิจ',
      },
    ],
    insights: [
...
const fallbackTemplate: CaseTemplate = {
  ...
  insights: [
    ...
    'หากไม่แน่ใจในสิทธิของตัวเอง สามารถสอบถามเพิ่มเติมได้ผ่าน Consult AI Assistant ได้ตลอด 24 ชั่วโมง',
  ],
  dueInDays: 30,
}
